...
**YOU ARE IN: `foop/polecats/angharad/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/foop/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/angharad
```
...
**Your mail address:** `foop/polecats/angharad`
**Your rig:** foop
**Your Witness:** `foop/witness`
...
1. Announce: "Polecat angharad, checking in."
...
| Ask Witness for help | `gt mail send foop/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`foop/witness`) when:
...
```bash
gt mail send foop/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
